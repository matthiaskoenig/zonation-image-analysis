...
def plot_overlay(image: np.ndarray, image_gauss: np.ndarray,
                 zonation: np.ndarray, zonation_gauss: np.ndarray,
                 cmap="gray", alpha=0.5, title: str = None, path: Path=None):
    """Plot the relevant channels."""
