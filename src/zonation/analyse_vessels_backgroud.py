"""Detect vessels and background from the slides."""
import numpy as np
from zonation import IMAGE_PATH
from zonation.analyse_zonation import histogram_normalization
from zonation.plots import plot_image_with_hist
from zonation.read_images import FluorescenceImage, Fluorophor


def run_vessel_detection(sid: str, show_plot: bool = True):
